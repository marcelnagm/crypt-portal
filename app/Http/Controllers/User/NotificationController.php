...
class NotificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('user.notification.index', compact('notification'));
    }
    ...
    public function edit($id)
    {
        ...
        $notification->save();
        return redirect('/user/notification')->with('flash_message', 'Notification updated!');
      ...
      public function allRead(Request $request){
        ...
        return redirect('/user/dashboard')->with('flash_message', 'Todas Lidas!');
    }
