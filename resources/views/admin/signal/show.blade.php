                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $signal->id }}</td>
                                    </tr>
                                    <tr><th> Pair Id </th><td> {{ $signal->pair_id }} </td></tr><tr><th> Entry Value </th><td> {{ $signal->entry_value }} </td></tr><tr><th> Target </th><td> {{ $signal->target }} </td></tr>
                                </tbody>
                            </table>
                        </div>
