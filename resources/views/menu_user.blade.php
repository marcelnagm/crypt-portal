		...
		<aside class="app-sidebar sidebar-scroll ">
			...
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{url('/user/')}}"><i class="side-menu__icon ti-desktop"></i><span class="side-menu__label">Início</span></a>
					</li>
					<li><h3>Gestão</h3></li>
					<li class="slide">
						<a class="side-menu__item" href="{{url('/user/signal')}}"><i class="side-menu__icon ti-stats-up"></i><span class="side-menu__label">Sinais</span></a>
					</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{url('/user/statistics')}}">Sinais</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{url('/user/configuration')}}">Telegram</a></li>
							<li><a class="slide-item" href="{{url('/user/configuration')}}">Outros</a></li>
						</ul>
					</li>
				</ul>
			</div>
